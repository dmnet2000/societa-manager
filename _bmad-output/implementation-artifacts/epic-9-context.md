...
- Story 9.6: due opzioni aperte — (a) link "Naviga" su Maps con ricerca testuale sull'`indirizzo` già esistente di `Palestra` (nessuna migrazione, coerente con NFR6), oppure (b) campo coordinate dedicato a mano dall'Admin/Dirigente (richiede migrazione).
