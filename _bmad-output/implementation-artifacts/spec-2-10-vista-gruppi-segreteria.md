...
**Execution:**
- [ ] `lib/auth/route-guard.ts` -- estendere `ruoliAmmessi` di `/app/gruppi`
- [ ] `app/app/(gruppi-allenatori)/gruppi/page.tsx` -- ramo di rendering in sola lettura per Segreteria
