...
export const CONTENUTI_GUIDA: ContenutoGuida[] = [
  ...
  },
  {
    ...
    corpo: [
      ...
      "Dentro un'Edizione, in \"Slot orari/Palestre\" crei gli orari di gioco disponibili (etichetta libera, data, ora, Palestra, e la fase a cui sono riservati - girone, semifinale, finale vincenti o finale perdenti, con il tabellone 1°-4° o 5°-8° per queste ultime tre). Per la fase a gironi non scegli una singola Palestra: un solo invio crea automaticamente uno Slot con la stessa etichetta/data/ora per ciascuna Palestra già censita nel gestionale (utile quando più gare si giocano in contemporanea su palestre diverse). Per semifinali e finali scegli invece la Palestra specifica, come sempre. Uno Slot già assegnato a un incontro non è cancellabile: rimuovi prima l'assegnazione.",
