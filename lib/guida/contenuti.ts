...
export const CONTENUTI_GUIDA: ContenutoGuida[] = [
  ...
  },
  {
    ...
    corpo: [
      ...
      "Finché il tabellone non è ancora generato, la stessa pagina \"Tabellone semifinali/finali\" mostra anche un prospetto ipotetico di sola lettura (nessuna squadra reale, nessun incontro creato) di come si incroceranno le posizioni di girone, con lo stesso schema descritto sopra per il numero di squadre in corso (4 o 3 per girone). Con qualunque altro numero di squadre per girone il prospetto non compare, e il tabellone non è generabile.",
